import aboutImage from "../assets/images/gameImage.jpg";
    ...
    return (
        <div className="bg-white">
            <div className="p-24 grid grid-cols-2">
                <div className="">
                    <h2 className="text-2xl font-medium">Sobre Nos</h2>
                    <p className="text-lg">
                ...
                <div className="flex items-center justify-center">
                    <img src={aboutImage} alt="" className="w-[300px] h-[200px] object-cover" />
                </div>
            </div>
        </div>
    )
