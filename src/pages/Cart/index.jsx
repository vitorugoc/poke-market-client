...
const Cart = () => {
    ...
    const tabs= ['Sumário', 'Entrega', 'Pagamento'];
    const [currentTab, handleTabSwitch] = useTabSwitch(tabs, 'Sumário');
    ...
    return (
        <div className="bg-white h-screen text-black mx-auto mt-2 border border-gray-200 p-4 md:w-2/3 rounded-lg shadow-md sm:p-6 lg:p-8">
            ...
            <div className={`tabs ${currentTab !== 'Sumário' ? 'hidden' : ''}`}>
                <ProductsSummary />
                <div className="flex justify-end p-2">
                    <Button variant="dark" className="flex items-center" onClick={()=>handleTabSwitch('Entrega')}><span className="mr-1">Next</span><ArrowRightSvg /></Button>
                </div>
            </div>
